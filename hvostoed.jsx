...
/* ---------- комнаты (прототип) ----------
   ...
   Полоса G (уровни 31–35, комнаты 6×6, доска 12×18) собрана genroomsdense.mjs
   ОБРАТНЫМ построением: финал комнаты режется на куски, плотность новых змей
   в комнате — 47–58% против 16–48% у прямых полос. Каждая комната со второй
   несёт ЦЕЛЕВУЮ ловушку: хвост куска дорощен в линию обстрела чемпиона, съесть
   его можно и соблазнительно, но клетки при обеде не исчезают — хвост замурует
   линию навсегда, и комната запирается; правильный ход — дать куску сначала
   съесть свою жертву и сдвигом уползти. Приёмка прогоняет жадную пробу («на
   каждом шаге ест самая длинная змея») и требует её ПРОВАЛА в каждой комнате
   со второй — ровно против «тыкаешь в одну змею, и она ест всех подряд». */
